...
export default function HeroSection() {
  return (
    <div className="px-4 py-8">
      ...
      <p className="text-secondary max-w-xl pt-4 text-base break-normal">
      ...
      >
        ...
        <Button
          className="text-secondary shadow-custom group hover:text-secondary mt-2"
          title="Resume Download"
          size="sm"
          variant="outline"
        >
          Resume{" "}
          <IconDownload className="group-hover:text-primary transition-all duration-300" />
        </Button>
        </Link>
      </motion.div>
    </div>
