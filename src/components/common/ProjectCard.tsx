...
export default function ProjectCard({
  ...
  return (
    <div className="group hover:shadow-custom relative rounded-xl border border-transparent p-4 transition-all duration-300 hover:border-neutral-200 dark:hover:border-neutral-800">
